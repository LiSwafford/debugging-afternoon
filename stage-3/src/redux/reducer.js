...
export default function reducer(state = initialState, action) {
  switch (action.type) {
    ...
    // it was missing state here,
    // when missing state, it was taking {shoppingCart:newArray} as the object to be assigned,
    //but this object doesn't have products array, so we will get the error of state was not defined.
    default:
      return state;
  }
}
